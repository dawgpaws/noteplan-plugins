# Task Automations Updated Noteplan Plugin

## Latest Updates

See [CHANGELOG](https://github.com/NotePlan/plugins/blob/main/dawgpaws.TaskAutomationsUpdated/CHANGELOG.md) for latest updates/changes to this plugin.
